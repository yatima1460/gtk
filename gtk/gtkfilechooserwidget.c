                        ...
                        gdouble               y)
{
  ...
  list = gtk_icon_view_get_selected_items (GTK_ICON_VIEW (priv->browse_files_icon_view));
  ...
  if (list)
    {
      ...
      rect.y = CLAMP (y, 0, gtk_widget_get_allocated_height (priv->browse_files_icon_view));
      rect.width = 40; 
